...
export const EditorData = () => (
  <div>
    <h3>
    Essayez de réagir
       React a été conçu dès le départ pour une adoption progressive, et vous pouvez utiliser aussi peu ou autant de React que nécessaire. Que vous souhaitiez avoir un avant-goût de React, ajouter de l'interactivité à une simple page HTML ou démarrer une application complexe alimentée par React, les liens de cette section vous aideront à démarrer.

       Terrains de jeux en ligne
       Si vous souhaitez jouer avec React, vous pouvez utiliser un terrain de jeu de code en ligne. Essayez un modèle Hello World sur CodePen, CodeSandbox ou Stackblitz.

       Si vous préférez utiliser votre propre éditeur de texte, vous pouvez également télécharger ce fichier HTML, le modifier et l'ouvrir à partir du système de fichiers local de votre navigateur. Il effectue une transformation lente du code d'exécution, nous vous recommandons donc de ne l'utiliser que pour des démonstrations simples.

       Ajouter React à un site Web
       Vous pouvez ajouter React à une page HTML en une minute. Vous pouvez ensuite soit étendre progressivement sa présence, soit la limiter à quelques widgets dynamiques.

       Créer une nouvelle application React
       Lors du démarrage d'un projet React, une simple page HTML avec des balises de script peut toujours être la meilleure option. Cela ne prend qu'une minute à mettre en place!

       Au fur et à mesure que votre application se développe, vous souhaiterez peut-être envisager une configuration plus intégrée. Il existe plusieurs chaînes d'outils JavaScript que nous recommandons pour les applications plus importantes. Chacun d'eux peut fonctionner avec peu ou pas de configuration et vous permet de tirer pleinement parti du riche écosystème React. Apprendre.

       Apprendre Réagir
       Les gens viennent à React d'horizons différents et avec des styles d'apprentissage différents. Que vous préfériez une approche plus théorique ou pratique, nous espérons que cette section vous sera utile.

       Si vous préférez apprendre en faisant, commencez par notre tutoriel pratique.
       Si vous préférez apprendre les concepts étape par étape, commencez par notre guide des principaux concepts.
       Comme toute technologie inconnue, React a une courbe d'apprentissage. Avec de la pratique et un peu de patience, vous y arriverez.

       Premiers exemples
       La page d'accueil de React contient quelques petits exemples de React avec un éditeur en direct. Même si vous ne connaissez pas encore React, essayez de modifier leur code et voyez comment cela affecte le résultat.

       React pour les débutants
       Si vous pensez que la documentation de React va plus vite que vous n'êtes à l'aise, consultez cet aperçu de React par Tania Rascia. Il présente les concepts les plus importants de React de manière détaillée et conviviale pour les débutants. Une fois que vous avez terminé, essayez à nouveau la documentation !

       Réagissez pour les concepteurs
       Si vous venez du milieu du design, ces ressources sont un excellent point de départ.

       Ressources JavaScript
       La documentation de React suppose une certaine familiarité avec la programmation en langage JavaScript. Vous n'avez pas besoin d'être un expert, mais il est plus difficile d'apprendre à la fois React et JavaScript en même temps.

       Nous vous recommandons de parcourir cet aperçu de JavaScript pour vérifier votre niveau de connaissances. Cela vous prendra entre 30 minutes et une heure mais vous vous sentirez plus confiant en apprenant React.
    </h3>
  </div>
);
...
export const chatData = [
  {
    image:
      avatar2,
    message: "Romain rejoint l'équipe !",
    desc: "Félicitez-le",
    time: '9:08 AM',
  },
  {
    ...
    desc: 'Salma vous a envoyé un nouveau message',
    time: '11:56 AM',
  },
  {
    image:
    ...
    desc: 'Vérifiez vos revenus',
    time: '4:39 AM',
  },
  {
    image:
      avatar,
    message: 'Tâches accomplies',
    desc: 'Attribuez-lui de nouvelles tâches',
    time: '1:12 AM',
  },
];
...
export const productsPerformance = [
  {
    image:
      product5,
    title: 'Est-ce une bonne glace au caramel ?',
    desc: 'Glace, Lait, Poudre',
    rating: 'Good',
    itemSold: '65%',
...
export const userProfileData = [
  ...
  },
  {
    icon: <FiCreditCard />,
    title: 'Mes Tâches',
    desc: 'À faire et tâches quotidiennes',
    iconColor: 'rgb(255, 244, 229)',
    iconBg: 'rgb(254, 201, 15)',
  },
];
...
export const pieChartData = [
  { x: 'Travail', y: 18, text: '18%' },
  { x: 'Juridique', y: 8, text: '8%' },
  { x: 'Production', y: 15, text: '15%' },
  { x: 'License', y: 11, text: '11%' },
  { x: 'Installations', y: 18, text: '18%' },
  { x: 'Taxes', y: 14, text: '14%' },
  { x: 'Assurance', y: 16, text: '16%' },
];
...
export const PyramidData = [
  { x: 'Gâteau', y: 120, text: '120 cal' },
  { x: 'Lait, Yaourt, Fromage', y: 435, text: '435 cal' },
  { x: 'Légumes', y: 470, text: '470 cal' },
  { x: 'Viande, Volaille, Poisson', y: 475, text: '475 cal' },
  { x: 'Fruits', y: 520, text: '520 cal' },
  { x: 'Pain, Riz, Pâtes', y: 930, text: '930 cal' },
];
